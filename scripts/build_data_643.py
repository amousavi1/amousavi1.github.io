"""Build DATA 443/643 lecture and lab pages, PDFs, and the weekly hub."""
...
LAST_UPDATED_ISO = "2026-09-16T22:50:00-04:00"
LAST_UPDATED_TEXT = "September 16, 2026, 10:50 PM EDT"

COURSE = "data-643"
COURSE_TITLE = "DATA 443/643"
COURSE_LONG = "Advanced Concepts in Large Language Models"
...
def _material_item(
    ...
    ext = ' target="_blank" rel="noopener"' if href.startswith("http") or href.endswith(".pdf") else ""
    return f"""                                    <li>
                                        <a class="course-material__title" href="{href}"{ext}>{title}</a
                                        >{extra}
                                    </li>"""
                ...
                <div class="page__inner-wrap">
                    ...
                    <section class="page__content" itemprop="text">
                        ...
                        <ul class="course-materials">
                            ...
                            <li>
                                <a class="course-material__title" href="{COURSE}-project-overview.html">Project overview</a
                                ><a class="course-material__pdf" href="files/{COURSE}/project-overview.pdf" target="_blank" rel="noopener">(PDF)</a>
                            </li>
                        </ul>
