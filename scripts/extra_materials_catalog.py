...
ITEMS = [
    ...
    {"src": f"{NOTES}/Seq2seq_models_loss.tex", "pdf": "seq2seq-loss.pdf", "title": "Seq2seq models and loss", "kind": "notes", "assign": [("data-641", 15)]},
    {"src": f"{NOTES}/Sequence_generating_models_evaluation.tex", "pdf": "sequence-eval.pdf", "title": "Evaluating sequence models", "kind": "notes", "assign": [("data-641", 15)]},
    {"src": f"{NOTES}/Forecast.tex", "pdf": "forecast.pdf", "title": "Forecasting with sequential models", "kind": "notes", "assign": [("data-641", 15)]},
    {"src": f"{Q641}/recom.tex", "pdf": "recommenders-extra.pdf", "title": "Recommender notes", "kind": "notes", "assign": [("data-641", 15)]},
    {"src": f"{NOTES}/Self-supervised_learning.tex", "pdf": "self-supervised.pdf", "title": "Self-supervised learning", "kind": "notes", "assign": [("data-641", 15), ("data-642", 15)]},
    {"src": f"{NOTES}/One_shot_learning.tex", "pdf": "one-shot.pdf", "title": "One-shot learning", "kind": "notes", "assign": [("data-641", 15), ("data-642", 15)]},
