...
ITEMS = [
    ...
    {"src": f"{NOTES}/SVM.tex", "pdf": "svm.pdf", "title": "SVM as a QP", "kind": "notes", "assign": [("data-641", 6), ("data-642", 6)]},
    ...
    {"src": f"{NOTES}/642-3-GD and Newton's Methods.tex", "pdf": "642-3-gd-newton.pdf", "title": "3. Gradient descent and Newton", "kind": "notes", "assign": [("data-642", 3)]},
    ...
    {"src": f"{NOTES}/ADMM_vs_PD.tex", "pdf": "admm-vs-pd.pdf", "title": "ADMM versus primal-dual", "kind": "notes", "assign": [("data-642", 4)]},
    {"src": f"{NOTES}/Augmented_Lagrangian_Method.tex", "pdf": "augmented-lagrangian.pdf", "title": "Augmented Lagrangian", "kind": "notes", "assign": [("data-642", 4)]},
    {"src": f"{NOTES}/642-6-Kernel Methods.tex", "pdf": "642-6-kernel-methods.pdf", "title": "6. Kernel methods", "kind": "notes", "assign": [("data-642", 5)]},
    {"src": f"{NOTES}/642-7-SVM.tex", "pdf": "642-7-svm.pdf", "title": "7. Support vector machines", "kind": "notes", "assign": [("data-642", 6)]},
    {"src": f"{NOTES}/642-16-Perceptron.tex", "pdf": "642-16-perceptron.pdf", "title": "16. Perceptron", "kind": "notes", "assign": [("data-642", 6)]},
    {"src": f"{NOTES}/Twin_SVM.tex", "pdf": "twin-svm.pdf", "title": "Twin SVM", "kind": "notes", "assign": [("data-642", 7)]},
    {"src": f"{NOTES}/One-Class-SVM.tex", "pdf": "one-class-svm.pdf", "title": "One-class SVM", "kind": "notes", "assign": [("data-642", 7)]},
    {"src": f"{NOTES}/SVM_TR.tex", "pdf": "svm-tr.pdf", "title": "SVM (technical remarks)", "kind": "notes", "assign": [("data-642", 7)]},
    {"src": f"{NOTES}/Ensemble_learning.tex", "pdf": "ensemble-learning.pdf", "title": "Ensemble learning", "kind": "notes", "assign": [("data-642", 8)]},
    {"src": f"{NOTES}/Incorporating_Heuristics.tex", "pdf": "heuristics.pdf", "title": "Incorporating heuristics", "kind": "notes", "assign": [("data-642", 8)]},
    ...
    {"src": f"{NOTES}/PCA.tex", "pdf": "pca.pdf", "title": "PCA", "kind": "notes", "assign": [("data-642", 12)]},
    {"src": f"{NOTES}/Matrix_Factorization.tex", "pdf": "matrix-factorization.pdf", "title": "Matrix factorization", "kind": "notes", "assign": [("data-641", 14), ("data-642", 12)]},
    {"src": f"{NOTES}/ICA.tex", "pdf": "ica.pdf", "title": "Independent component analysis", "kind": "notes", "assign": [("data-642", 13)]},
    {"src": f"{NOTES}/ICA1.tex", "pdf": "ica-extended.pdf", "title": "ICA (extended notes)", "kind": "notes", "assign": [("data-642", 13)]},
    {"src": f"{NOTES}/IVA.tex", "pdf": "iva.pdf", "title": "Independent vector analysis", "kind": "notes", "assign": [("data-642", 13)]},
    {"src": f"{NOTES}/CCA.tex", "pdf": "cca.pdf", "title": "Canonical correlation analysis", "kind": "notes", "assign": [("data-642", 13)]},
    {"src": f"{NOTES}/Tensors.tex", "pdf": "tensors.pdf", "title": "Tensors", "kind": "notes", "assign": [("data-642", 13)]},
    {"src": f"{NOTES}/Multimodal_Learning.tex", "pdf": "multimodal-learning.pdf", "title": "Multimodal learning", "kind": "notes", "assign": [("data-642", 14)]},
    {"src": f"{NOTES}/Multi_modal.tex", "pdf": "multimodal.pdf", "title": "Multimodal methods", "kind": "notes", "assign": [("data-642", 14)]},
    {"src": f"{NOTES}/CLIP.tex", "pdf": "clip.pdf", "title": "CLIP", "kind": "notes", "assign": [("data-642", 14)]},
    {"src": f"{NOTES}/Embeddings_images.tex", "pdf": "embeddings-images.pdf", "title": "Image embeddings", "kind": "notes", "assign": [("data-642", 14)]},
    {"src": f"{NOTES}/NNs.tex", "pdf": "neural-nets.pdf", "title": "Neural networks", "kind": "notes", "assign": [("data-642", 15)]},
    {"src": f"{NOTES}/back-propagation.tex", "pdf": "backpropagation.pdf", "title": "Back-propagation", "kind": "notes", "assign": [("data-642", 15)]},
    {"src": f"{NOTES}/autoencoders.tex", "pdf": "autoencoders.pdf", "title": "Autoencoders", "kind": "notes", "assign": [("data-642", 15)]},
    {"src": f"{NOTES}/U-net.tex", "pdf": "unet.pdf", "title": "U-Net", "kind": "notes", "assign": [("data-642", 15)]},
    {"src": f"{Q642}/notes_on_U-net.tex", "pdf": "unet-notes.pdf", "title": "U-Net notes", "kind": "notes", "assign": [("data-642", 15)]},
    ...
    {"src": f"{NOTES}/642_quiz_1_solution.tex", "pdf": "quiz-1-solutions.pdf", "title": "Quiz 1 solutions", "kind": "practice", "assign": [("data-642", 4)]},
    {"src": f"{Q642}/quiz1_sol.tex", "pdf": "quiz-1-solutions-alt.pdf", "title": "Module 1 quiz solutions", "kind": "practice", "assign": [("data-642", 4)]},
    {"src": f"{Q642}/Quiz1_Solution.tex", "pdf": "quiz-1-solution-set.pdf", "title": "Module 1 quiz solution set", "kind": "practice", "assign": [("data-642", 4)]},
    {"src": f"{Q642}/quiz2_sol.tex", "pdf": "quiz-2-solutions.pdf", "title": "Module 2 quiz solutions", "kind": "practice", "assign": [("data-642", 6)]},
