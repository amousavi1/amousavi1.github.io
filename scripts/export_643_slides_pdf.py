    ...
    },
    {
        ...
        "slides": [
            ...
            },
            {
                ...
                "title": "Lecture plan",
                "agenda": [
                    ("1", "Train the reader on the test stack"),
                    ("2", "Gold plus distractors"),
                    ("3", "Weights versus an index"),
                    ("4", "Week 14 owns the RAG pipeline"),
                ],
        ...
        "slides": [
            {
                ...
                "credit": "Ideas from Stanford CS224N 2026 L10 (RAG at inference). Original slides; that course is not copied.",
            },
            {
                "layout": "agenda",
                "title": "Lecture plan",
                "agenda": [
                    ("1", "Non-parametric memory at request time"),
                    ("2", "Cosine rank on three toy docs"),
                    ("3", "k=1 vs k=2: near-miss d3"),
                    ("4", "Not Week 10 RAFT"),
                ],
                "takeaway": "Key goal: recall@k and an attribution check, plus a no-RAG baseline.",
            },
            {
                "layout": "split",
                "title": "Conditioning, not a new net",
                "bullets": [
                    "Index chunks. Retrieve top-k. Stuff, then generate.",
                    "CS224N L10: facts live in the index, not only in weights.",
                    "Week 10.3 RAFT trains on those docs. This week is inference.",
                ],
                "image": "graphics/14.1-rag-pipeline/rag.png",
            },
            {
                "layout": "equation",
                "title": "Bag-of-words cosine",
                "equation": r"\cos(q,d)=\frac{q^{\top}d}{\|q\|\,\|d\|}",
                "notes": [
                    r"\(q=d1=(1,1,0)\): cosine 1 with itself.",
                    r"\(d3=(1,0,0)\): \(1/\sqrt{2}\approx 0.707\). \(d2\): 0.",
                    "Lab 14 prints this ranking. No GPU.",
                ],
            },
            {
                "layout": "split",
            ...
            },
            {
                ...
                "left": "A training recipe: learn to use retrieved docs. Weights change.",
                "right_title": "14.1 this hour",
                "right": "The inference stack: index, retrieve, generate, cite. Measure recall@k.",
            },
            {
                "layout": "cards",
                "title": "What to take from this lecture",
        ...
        "slides": [
            {
                ...
                "meta": "Week 14  ·  American University  ·  Ahmad Mousavi",
                "credit": "Ideas from Stanford CS224N 2026 L10 (ReAct vs CoT vs SC). Original slides; that course is not copied.",
            },
            {
                "layout": "agenda",
                "title": "Lecture plan",
                "agenda": [
                    ("1", "A tool call is not a thought"),
                    ("2", "ReAct vs CoT vs self-consistency"),
                    ("3", "calc[17*24] returns 408"),
                    ("4", "Ignored observations"),
                ],
                "takeaway": "Key goal: the next thought must use the observation.",
            },
            {
                "layout": "split",
                "title": "Call the world, then continue",
                "bullets": [
                    "Thought is scratch. Action is structured. Observation comes back.",
                    "CS224N L10: CoT can invent facts. ReAct is supposed to wait for the tool.",
                    "RAG retrieve is one tool. calc is another.",
                ],
            ...
            {
                "layout": "compare",
                "title": "Three control loops (CS224N L10)",
                "left_title": "CoT / SC",
                "left": "Text only. SC votes k traces. No observation from the world.",
                "right_title": "ReAct",
                "right": "Interleave thoughts with tool results. Cap steps. Parse actions strictly.",
            },
            {
                "layout": "compare",
                "title": "ToT is still not ReAct",
                "left_title": "Tree-of-Thoughts",
                "left": "Search among partial thoughts. The scorer can be a checker.",
                "right_title": "ReAct",
                "right": "The node can be a tool call. Missing a line in the log means you ran CoT.",
            },
            {
                "layout": "cards",
                "title": "What to take from this lecture",
                "cards": [
                    ...
                    ("Dummy calc", "Lab 14 is not python_eval. Keep it dummy."),
