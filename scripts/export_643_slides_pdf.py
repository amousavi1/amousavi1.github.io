...
DECKS = [
    {
        ...
        "slides": [
            ...
            },
            {
                ...
                "title": "Lecture plan",
                "agenda": [
                    ("1", "Four modules, taught bottom-up"),
                    ("2", "The same object as a stack; Week 1 is the base"),
                    ("3", "What those weights were trained to do"),
                    ("4", "The weights file is 140 GB"),
                    ("5", "The project names one layer"),
                ],
                "takeaway": "Key goal: one stack picture, one next-token loss, one measurable project sentence.",
            },
            {
                "layout": "split",
                "title": "Four modules, one object",
                "bullets": [
                    "Listed prereq: DATA 427/627. DATA 641 and 642 are not required.",
                    "Overlap is intentional: neural nets and embeddings are taught here.",
                    "The semester job is a measured project, not four electives.",
                ],
                "image": "graphics/1.1-course-map/roadmap.png",
            },
            {
                "layout": "split",
                "title": "The same object as a stack",
                "bullets": [
                    "Chat products sit at the top: decoding, tools, a UI.",
                    "The weights still came from next-token training at the bottom.",
            ...
            {
                "layout": "compare",
                "title": "The project names one layer",
                "left_title": "A method",
                "left": "Use LoRA on news.",
                "right_title": "A question plus a metric",
    ...
    },
    {
        ...
        "slides": [
            ...
            {
                "layout": "bullets",
                "title": "Four ways to ship a large net",
                "bullets": [
                    "Prune zeros weights. Quantize uses fewer bits. Distill trains a smaller student. Speculate drafts then verifies.",
                    r"A 7B in fp16 is \(\approx 14\) GB. Serving is memory and tokens/s, not only loss.",
                    r"Affine INT8: \(x\approx s(q-z)\). Speculative accept if \(p_{\mathrm{target}}(x)\ge p_{\mathrm{draft}}(x)\).",
                    "Fits RAM and can speed decode. Outliers blow the scale; a rejected draft wasted the small model.",
                ],
            },
            {
                "layout": "split",
    ...
    },
    {
        ...
        "slides": [
            ...
            {
                "layout": "bullets",
                "title": "Editing versus unlearning",
                "bullets": [
                    "Edit: rewrite one fact. Unlearn: lower a set of behaviors. They are not the same experiment.",
                    "Retraining from scratch is too expensive. Serving a wrong object is a product bug.",
                    r"Locate the MLP, then \(W\leftarrow W+uv^{\top}\) so \(W'k_*=v_*\). Unlearn: continue train + retain set.",
                    "Cheap write. Neighbors leak; paraphrases miss. Retain accuracy is the cost of unlearning.",
                ],
            },
            {
                "layout": "split",
        ...
        "slides": [
            ...
            },
            {
                ...
                "bullets": [
                    ...
                    "Week 14.1 is the full retrieve-then-generate stack. This hour trains the reader.",
                ],
