...
Mixtral’s row to memorize: **8 routed experts, top-2 active, no shared expert.** Switch Transformer used \(k=1\). DeepSeek-style 256-expert nets wait; this hour is stored versus active.
