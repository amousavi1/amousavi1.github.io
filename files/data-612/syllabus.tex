...
\vspace{1mm} \\
\noindent \underline{Quizzes (15\%)}: Three in-class {\bf cumulative} quizzes with each having 5\% of the total grade. Quizzes are closed-notes: you may use R and RStudio, but not the internet or any notes. 
\vspace{1mm} \\
