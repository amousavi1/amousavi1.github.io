...
![](files/data-612/graphics/data-structures-overview.png)
...
1. Build a wedding-style list: a `venue`, a `guest` tibble (name, meal, age), a `bride`, a `groom`, and a `date`. Remove one guest row from the embedded tibble. Add a named vector that decodes the meal codes. Extract the venue two ways.
