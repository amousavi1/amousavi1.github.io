...
knitr::opts_chunk$set(
  ...
  dpi = 120,
  error = TRUE,
  fig.path = "_figs/data-science-and-r/"
)
library(tidyverse)
```
...
![A Venn diagram of statistics, computing, and domain knowledge](files/data-612/graphics/DS_venn_annotated.png)
...
![The R for Data Science cycle](files/data-612/graphics/R4DS_cycle.png)
...
1. In one sentence, what mix of skills does a data-science project need?
2. Name the six verbs on the R for Data Science cycle.
3. Why does this course use R rather than a spreadsheet for the same tables?
