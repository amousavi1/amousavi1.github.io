...
knitr::opts_chunk$set(
  ...
  dpi = 120,
  error = TRUE,
  fig.path = "_figs/dplyr-filtering-joins/"
)
library(tidyverse)
```
...
![](files/data-612/graphics/join-semi.png)

![](files/data-612/graphics/join-anti.png)

![](files/data-612/graphics/join-one-to-many.png)

![](files/data-612/graphics/join-many-to-many.png)
